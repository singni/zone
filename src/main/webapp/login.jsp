...
<div class="main-inner" id="mainCnt"
     style="width: 100%; height: 100%; overflow: hidden; position: absolute; left: 0%; top: 0; margin-left: 0px; margin-top: 0px; background-image: url('${pageContext.request.contextPath }/images/bg_login.jpg')">
    <div id="loginBlock" class="login"
         style="margin-top: 270px; height: 255px;">
        <div class="loginFunc">
